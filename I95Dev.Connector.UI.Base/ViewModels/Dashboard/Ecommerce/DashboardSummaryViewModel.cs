...
namespace I95Dev.Connector.UI.Base.ViewModels.Dashboard.Ecommerce
{
    public class DashboardSummaryViewModel : BaseViewModel
    {
        ...
        private void LoadViewAllPage()
        {
            ...
            var dashboardViewModel = new EcommerceViewModel(fromTime);
        ...
        private void LoadDataToUi()
        {
            ...
            {
                new MessageSummaryModel { EntityId = (int)Entity.Product, EntityName = "Products", CompleteCount = 0, ProcessingCount= 0, ErrorCount=0 },
                new MessageSummaryModel { EntityId = (int)Entity.SalesOrder, EntityName = "Sales Orders", CompleteCount = 0, ProcessingCount=0, ErrorCount=0 },
                new MessageSummaryModel { EntityId = (int)Entity.Customer, EntityName = "Customers", CompleteCount = 0, ProcessingCount=0, ErrorCount=0 },
                new MessageSummaryModel { EntityId = 0, EntityName = "Others", CompleteCount = 0, ProcessingCount=0, ErrorCount=0 },
            };
